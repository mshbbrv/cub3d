...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   render_walls_utils2.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: thjonell <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/03/12 14:12:45 by thjonell          #+#    #+#             */
/*   Updated: 2021/03/12 14:14:02 by thjonell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (all->rc.side == 0)
		all->wall.wall_x = all->map_data.pl_y + all->rc.perp_dist *
				all->rc.ray_dir_y;
	else
		all->wall.wall_x = all->map_data.pl_x + all->rc.perp_dist *
				all->rc.ray_dir_x;
...
void	draw_walls(t_all_data *all, int x)
{
	...
	while (all->wall.draw_start < all->wall.draw_end)
	{
		...
		all->wall.color = tex_color(&all->texture, all->wall.tex_x,
		all->wall.tex_y);
